...
Revision ID: 0b3d73027c2d
Revises: 
Create Date: 2025-01-31 18:36:49.567288
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'movie_id', name='unique_purchases_constraint')
    )
